...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#020617]/80 backdrop-blur-lg border-b border-white/5" style={{ fontFamily: "'Manrope', sans-serif" }}>
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <Link to="/autenticidade" className="text-muted-foreground hover:text-foreground transition-colors text-sm">
              Autenticidade
            </Link>
