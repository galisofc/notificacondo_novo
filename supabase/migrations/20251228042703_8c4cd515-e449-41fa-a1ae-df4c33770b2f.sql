-- Drop and recreate the function with super_admin permission check
...
-- Grant execute permissions to authenticated users (but function will check role internally)
